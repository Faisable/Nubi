...
const long interval_Mesure_Qualite_Air      =    3000;
...
#define Valeur_Froid_temp 17
#define Valeur_Chaud_temp 26

#define Valeur_Sec_hum     35
#define Valeur_Humide_hum 65
...
Serial.println(Valeur_qualite);
 ...
 if(Wifi_OK==false){ pixels.setPixelColor(Icone_Wifi,   pixels.Color(V_Orange  ));}else{pixels.setPixelColor(Icone_Wifi,   pixels.Color(V_Vert ));}
...
void Mise_a_jour_Afficheur()
{
   Serial.println("Mise_a_jour_Afficheur()");
    ...
    display.setCursor(0,20);  display.println("Air:");          display.setCursor(45,20); if(Valeur_qualite>Seuil_qualite_air)  {display.println("Mauvais");} else {display.println("Sain");}//display.println("Aerez");
